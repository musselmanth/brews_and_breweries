...
odell.beers.create(name: "Drumroll", abv: 5.3, ibu: 42, style:"Pale Ale", limited_release: false)
crooked_stave.beers.create(name: "Sour Rosé", abv: 4.5, ibu: 0, style:"Wild Ale", limited_release: false)
crooked_stave.beers.create(name: "Colorado Wild Sage", abv: 7.2, ibu: 0, style:"Farmhouse Ale", limited_release: false)
deschutes.beers.create(name: "Fresh Squeezed", abv: 6.4, ibu: 60, style:"IPA", limited_release: false)
deschutes.beers.create(name: "Obsidian Stout", abv: 6.4, ibu: 55, style:"American Stout", limited_release: false)
stone.beers.create(name: "Delicious IPA", abv: 7.7, ibu: 75, style:"Session IPA", limited_release: false)
stone.beers.create(name: "Buenaveza Sale & Lime Lager", abv: 4.7, ibu: 13, style:"Mexican Lager", limited_release: false)
